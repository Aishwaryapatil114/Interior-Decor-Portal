...
{
$err1="PaymentId must exist";
$fl=1;
}
if(empty($_POST['paymentdate']))
{
$err2="payment date must exist";
$fl=1;
}
if(empty($_POST['employeeid']))
{
$err3="employee id must exist";
$fl=1;
}
...
<body style="background:white"> 
  ...
  <section id="main1" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up" >
      ...
      <table class="tab1">
        <center>
      <h2 class="h11">Payment Form</h>
                <!-- Payment ID -->
        <tr>
          <td ><label for="Payment ID" style="colspan:2"> Payment ID</label></td><br>
          <td><input type="number" name="Paymentid"  style= "width:166px;"  onkeypress="return valid1()"/></td>
          <td><?php echo "<font color='red'>".$err1."</font>";?></td>
          
        </tr>
        <!--Payment Date-->
        <tr>
          <td><label for="Payment Date">Payment Date</label> <br></td>
          <td><input type="date" name="paymentdate" style="width:166px"></td>
...
<td>
<select name="Employeeid"  style="width:166px" onkeypress="return valid1()"> 
<option value=select>select</option>
<?php
$cn=mysql_connect("localhost","root");
mysql_select_db("interiordesign",$cn);
$sql="select distinct employeeid from employee";
...
?>
        ...
        <tr>
          ...
          <td> <input type="number" name="amount"  style="width:166px" onkeypress="valid1()"></td>
...
//   if($fl==0)
// {
$sql="update payment set paydate='$_POST[paymentdate]',employeeid='$_POST[Employeeid]',amt='$_POST[amount]' where payid='$_POST[Paymentid]'";
mysql_query($sql,$cn);
...
echo "<br><h2><font color='black' size='30px'>Payment form</font></h2>";
echo "<tr>";
echo "<th>payid</th>";
echo "<th>paydate</th>";
