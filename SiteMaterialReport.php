...
<body id="main3"> 
    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="indexuser.html">Rm<span>.</span></a></h1>
    ...
    <body>
        <form name=frm method=post action="SiteMaterialReport.php">
            <center>
                <!-- <h1>Site Material Report</h1> -->
                <div class="buttons">
...
if($sb=="Display")
{
    ...
    echo "<br><h2><font color='White' size='40px'>SiteMaterial report</font></h2>";
echo "<tr>";
...
echo "<input name=btn value=print onclick=toprint()>";
echo "</div>";
echo"</center>";
}
}
